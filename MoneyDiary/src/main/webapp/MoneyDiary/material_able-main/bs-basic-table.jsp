                            ...
                            <div class="">
                                <div class="main-menu-header">
                                    ...
                                    <div class="user-details">
                                        <span id="more-details" style="color:#666;">ì½ì½ì´<i class="fa fa-caret-down"></i></span>
                                    </div>
                                </div>
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header" style="background-color:#cff09e">
                                                <h4 style="margin-top:5px">가계부 자세히 보기</h4>
                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                	<%
                                                		//String tmpDate = "04월23일";
                                                		while(rs3.next()){
                                                	%>
                                                    <table class="table">
                                                        <thead>
                                                            <tr>
                                                                <th style="width:25%;padding:2px2px2px2px;vertical-align:middle;">
                                                                    <h5 class="f-w-700" style="margin-bottom:0px;">
                                                                        <%=rs3.getString("MN_DATE") %>
                                                                    </h5>
                                                                </th>
                                                                <th style="width:25%">

                                                                </th>
                                                                <th style="width:25%;padding:2px 2px 5px 2px;">
                                                                    <h5 class="f-w-700" style="color:blue;text-align:center;padding-top:8px;">
                                                                        <%=price.format(Integer.parseInt(rs3.getString("INCOME"))) %>
                                                                    </h5>
                                                                </th>
                                                                <th style="width:25%;padding:2px 2px 5px 2px;">
                                                                    <h5 class="f-w-700" style="color:red;text-align:center;padding-top:8px;">
                                                                        <%=price.format(Integer.parseInt(rs3.getString("OUTCOME"))) %>
                                                                    </h5>
                                                                </th>
                                                            </tr>
                                                        </thead>
                                                        ...
                                                        <%
                                                        	while(rs.next()){
                                                        		if(rs3.getString("MN_DATE").equals(rs.getString("MN_DATE"))){
                                                        			if(rs.getString("INOUT").equals("O")){
                                                        %>
                                                            <tr>
                                                                <th scope="row" style="width:25%;vertical-align:middle;font-size:18px;">
                                                                      <%=rs.getString("C_NAME") %>
                                                                </th>
                                                                <td style="width:25%;padding:0px0px0px0px;vertical-align:middle;">
                                                                    <div>
                                                                ...
                                                                <td style="width:25%;color:blue;text-align:center;vertical-align:middle;">

                                                                </td>
                                                                <td style="width:25%;color:red;text-align:center;vertical-align:middle;">
                                                                    <%=price.format(Integer.parseInt(rs.getString("M_PRICE"))) %>
                                                                </td>
                                                            </tr>
                                                            <%
                                                        		}else{
